...
```xml
  <ItemGroup>
    <PackageReference Include="RSCG_Templating" Version="2026.420.2103" OutputItemType="Analyzer"  ReferenceOutputAssembly="false"   />
    <PackageReference Include="RSCG_TemplatingCommon" Version="2026.420.2103" />
  </ItemGroup>
